function calc(){
  ...
  function generate_line_table(size,data){
  ...
  function generate_rect_table(size,data){
    let calc1 = '<div class="calc-2" style="grid-template-columns:'+ " 1fr".repeat(size) +';"></div><div></div>';
    let svg = '';
  ...
  function generate_triangle_table(size,data){
  ...
  generate_triangle_table(3,data)
}
